...
public class search extends javax.swing.JFrame {
    ...
    public search() {
        ...
        try {
            ob = DriverManager.getConnection("jdbc:mysql://localhost:3306/project", "root", "ثسمشة");
    ...
    private void fillTableModel(){
        ...
        try {
            dtm.setRowCount(0);
            p = ob.prepareStatement("select * from newcustomer");
            ResultSet rs = p.executeQuery();
            while(rs.next()){
                dtm.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getString(5), rs.getString(6)});
                custIds.add(rs.getInt(7));
            }
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        try {
            stmt = ob.prepareStatement("delete from newcustomer where customer_id = ?");
            stmt.setInt(1, custIds.get(jTable1.getSelectedRow()));
            stmt.executeUpdate();
